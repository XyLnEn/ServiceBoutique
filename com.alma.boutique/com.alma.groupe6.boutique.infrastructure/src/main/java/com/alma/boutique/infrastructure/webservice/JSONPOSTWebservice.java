 ...
 */
public class JSONPOSTWebservice<T> implements WebService<T> {
    private static final Logger logger = Logger.getLogger(JSONPOSTWebservice.class);
     ...
     */
    public JSONPOSTWebservice(String baseURL, Class<T> referenceClass) {
     ...
     * @param url the url to which we want to do a POST
